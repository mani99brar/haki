export const PUBLIC_RESOLVER_ABI = [
  ...
  },
  {
    ...
    outputs: [{ name: "addressBytes", type: "bytes", internalType: "bytes" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "node", type: "bytes32", internalType: "bytes32" },
      { name: "coinType", type: "uint256", internalType: "uint256" },
      { name: "addressBytes", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      { name: "node", type: "bytes32", internalType: "bytes32" },
      { name: "interfaceID", type: "bytes4", internalType: "bytes4" },
      { name: "implementer", type: "address", internalType: "address" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      { name: "node", type: "bytes32", indexed: true, internalType: "bytes32" },
      { name: "hash", type: "bytes", indexed: false, internalType: "bytes" },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: "node", type: "bytes32", indexed: true, internalType: "bytes32" },
      { name: "x", type: "bytes32", indexed: false, internalType: "bytes32" },
      { name: "y", type: "bytes32", indexed: false, internalType: "bytes32" },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: "addressBytes", type: "bytes", internalType: "bytes" }],
  },
  {
    type: "error",
